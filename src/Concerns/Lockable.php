...
trait Lockable
{
    ...
    public function acquireLock(?int $ttl = null, ?string $owner = null, ?string $reason = null): LockResult
    {
        $action = Config::getAction('acquire_model', AcquireModelLockAction::class);
    ...
    {
        $action = Config::getAction('release_model', ReleaseModelLockAction::class);
